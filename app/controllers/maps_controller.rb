...
=begin
 flag = [
     [ImageProcessedTable.find_by(x: x-1, y: y+1, z: z).present?, ImageProcessedTable.find_by(x: x, y: y+1, z: z).present?, ImageProcessedTable.find_by(x: x+1, y: y+1, z: z).present?],
     [ImageProcessedTable.find_by(x: x-1, y: y, z: z).present?, ImageProcessedTable.find_by(x: x, y: y, z: z).present?, ImageProcessedTable.find_by(x: x+1, y: y, z: z).present?],
     [ImageProcessedTable.find_by(x: x-1, y: y-1, z: z).present?, ImageProcessedTable.find_by(x: x, y: y-1, z: z).present?, ImageProcessedTable.find_by(x: x+1, y: y-1, z: z).present?]
    ]
=end
